    ...
    def add_student(self, name, roll_number, grade):
        while True:
            try:
                ...
                print("შეცდომა: არასწორი სიის ნომერი, შეიყვანეთ მხოლოდ რიცხვი.")
                break
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            roll_number = int(input("შეიყვანე სტუდენტის სიის ნომერი "))
            sms.search_student_by_roll_number(roll_number)
        elif choice == 4:
            roll_number = int(input("სტუდენტის შეფასების გასაახელბლად შეიყვანე სტუდენტის ნომერი: "))
